...
const Header = () => {
  ...
  const navigationSections = {
    ...
    backgroundInvestigations: [
      { to: '/investigations/dashboard', label: 'Dashboard' },
      { to: '/investigations/active', label: 'Active Cases' },
      { to: '/investigations/cases', label: 'Case Management' },
      { to: '/investigations/timeline', label: 'Investigation Timeline' },
      { to: '/investigations/subjects', label: 'Subject Records' },
      { to: '/investigations/interviews', label: 'Interview Scheduling' },
      { to: '/investigations/evidence', label: 'Evidence Tracking' },
      { to: '/investigations/references', label: 'Reference Checks' },
      { to: '/investigations/employment', label: 'Employment Verification' },
      { to: '/investigations/criminal', label: 'Criminal History Review' },
      { to: '/investigations/financial', label: 'Financial Background' },
      { to: '/investigations/social', label: 'Social Media Analysis' },
      { to: '/investigations/reports', label: 'Reports' },
      { to: '/investigations/closure', label: 'Case Closure' },
    ],
  };

        ...
        <header className="border-b border-slate-800/50 backdrop-blur-xl bg-slate-900/30">
          <div className="px-4 lg:px-6 py-4 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              <button className="hidden lg:flex items-center gap-2 px-3 py-2 bg-slate-800/40 hover:bg-slate-800/60 border border-slate-700/50 text-slate-300 rounded-xl text-sm transition-all">
                ...
                {notificationsOpen && (
                  <div className="absolute right-0 top-full mt-2 w-96 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-xl shadow-2xl z-50">
                    <div className="p-4 border-b border-slate-700/50">
                      <h3 className="text-sm font-semibold text-white">Training Notifications</h3>
                    </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">Annual qualification deadline January 31, 2026 - Grace period expired February 05 - Range day scheduled February 12, 2026</p>
                  </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">Both removed from sworn duties - Renewal training scheduled February 10-14, 2026 at GPSTC-Columbus</p>
                  </div>
                  <span className="px-2 py-1 bg-red-500/20 border border-red-500/40 text-red-400 rounded-lg text-xs font-bold whitespace-nowrap">CRITICAL</span>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">POST (8), TASER (5), CPR/First Aid (10) - Review individual expiration dates below</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">Due by March 31, 2026 - 3 training sessions scheduled (Feb 18, Mar 3, Mar 17) - Range time required</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-slate-400 mt-0.5">Both removed from sworn duties, renewals in progress</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-1 bg-red-500/20 border border-red-500/40 rounded text-xs text-red-400 font-bold">EXPIRED</span>
                    {expandedViolation.post ? <ChevronUp className="w-4 h-4 text-slate-400" /> : <ChevronDown className="w-4 h-4 text-slate-400" />}
                  </div>
                </button>
                      ...
                      {criticalViolations.expiredPost.deputies.map((deputy, idx) => (
                        <div key={idx} className="bg-red-500/5 border border-red-500/20 rounded-lg p-4">
                          <div className="flex items-start justify-between gap-4 flex-wrap">
                            <div>
                              <p className="text-sm font-medium text-white">{deputy.name} <span className="text-slate-400">({deputy.badge})</span></p>
                              <p className="text-xs text-slate-400 mt-1">{deputy.certLevel} - Expired {deputy.expiredDate} ({deputy.daysExpired} days)</p>
                            </div>
                            <span className="px-2 py-1 bg-red-500/20 text-red-400 rounded text-xs font-medium">{deputy.status}</span>
                          </div>
                          <div className="mt-3 flex items-center gap-2 text-xs">
                            <CheckCircle2 className="w-3.5 h-3.5 text-green-400" />
                            <span className="text-slate-300">Renewal Training: {deputy.renewalTraining}</span>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-slate-400 mt-0.5">GCSO Policy 4.12 | Deadline: {criticalViolations.overdueFirearms.deadline} | Grace expired {criticalViolations.overdueFirearms.graceExpired}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-1 bg-red-500/20 border border-red-500/40 rounded text-xs text-red-400 font-bold">OVERDUE</span>
                    {expandedViolation.firearms ? <ChevronUp className="w-4 h-4 text-slate-400" /> : <ChevronDown className="w-4 h-4 text-slate-400" />}
                  </div>
                </button>
                  ...
                  <div className="px-5 pb-5 border-t border-red-500/20">
                    ...
                    <div className="mt-4 space-y-4">
                      {criticalViolations.overdueFirearms.divisions.map((div, idx) => (
                        <div key={idx}>
                          <h5 className="text-xs font-semibold text-slate-300 mb-2">{div.name} ({div.count}):</h5>
                    ...
                    <div className="mt-4 bg-slate-900/40 border border-slate-700/30 rounded-lg p-4">
                      <h5 className="text-xs font-semibold text-slate-300 mb-2">Firearms Qualification Requirements (GCSO Policy 4.12):</h5>
              ...
              <div className="mb-4 bg-slate-800/40 border border-red-500/30 rounded-xl overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-slate-400 mt-0.5">GCSO Policy 4.15 | Deputies cannot carry TASER without current certification</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-1 bg-red-500/20 border border-red-500/40 rounded text-xs text-red-400 font-bold">EXPIRED</span>
                    {expandedViolation.taser ? <ChevronUp className="w-4 h-4 text-slate-400" /> : <ChevronDown className="w-4 h-4 text-slate-400" />}
                  </div>
                </button>
                ...
                {expandedViolation.taser && (
                  <div className="px-5 pb-5 border-t border-red-500/20">
                      ...
                      {criticalViolations.expiredTaser.deputies.map((deputy, idx) => (
                        <div key={idx} className="bg-red-500/5 border border-red-500/20 rounded-lg p-4">
                          <div className="flex items-start justify-between gap-4 flex-wrap mb-2">
                            <div>
                              <p className="text-sm font-medium text-white">{deputy.name} <span className="text-slate-400">({deputy.badge})</span></p>
                              <p className="text-xs text-slate-400 mt-0.5">{deputy.division}</p>
                            </div>
                            <span className="px-2 py-1 bg-red-500/20 text-red-400 rounded text-xs font-medium">{deputy.daysOverdue} DAYS OVERDUE</span>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-slate-400 mt-2">
                          ...
                          <div className="mt-2 flex items-center gap-2 text-xs">
                            <CheckCircle2 className="w-3.5 h-3.5 text-green-400" />
                            <span className="text-slate-300">Recertification class: {deputy.recertClass}</span>
                            {deputy.enrolled && <span className="px-1.5 py-0.5 bg-green-500/20 text-green-400 rounded text-[10px] font-medium">ENROLLED</span>}
                          </div>
                    ...
                    <div className="mt-4 p-3 bg-slate-900/40 border border-slate-700/30 rounded-lg text-xs text-slate-400">
                      <p className="font-medium text-slate-300 mb-1">Supervisor Accountability:</p>
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                      activeCategory === filter.id
                        ...
                        : 'bg-slate-800/40 border border-slate-700/50 text-slate-400 hover:text-white hover:bg-slate-800/60'
                    }`}
                  >
                    {filter.label}
                  </button>
                      ...
                      <div key={category.id} className={`bg-slate-800/40 border ${category.borderColor} rounded-xl overflow-hidden`}>
                        ...
                        {isExpanded && (
                          <div className="px-5 pb-5 border-t border-slate-700/30">
                            ...
                            <div className="mt-4 p-3 bg-slate-900/40 border border-slate-700/30 rounded-lg">
                              <p className="text-[10px] text-slate-500 mb-1">Regulatory Authority: <span className="text-slate-400">{category.authority}</span></p>
                              <p className="text-xs text-slate-300 mt-1">{category.requirement}</p>
                            </div>

                            {/* Certification Status */}
                            <div className="mt-4">
                              <h5 className="text-xs font-semibold text-slate-300 mb-3">Certification Status:</h5>
                                ...
                                <div className="bg-green-500/5 border border-green-500/20 rounded-lg p-3">
                                  ...
                                  {category.stats.breakdown && (
                                    <div className="space-y-1 ml-6">
                                      {category.stats.breakdown.map((level, idx) => (
                                        <p key={idx} className="text-[10px] text-slate-400">{level.level}: {level.count} ({level.pct})</p>
                                      ))}
                                    </div>
                                  )}
                                  ...
                                  {category.stats.qualDates && (
                                    <div className="ml-6 space-y-1">
                                      <p className="text-[10px] text-slate-400">Qualified: {category.stats.qualDates}</p>
                                      <p className="text-[10px] text-slate-400">Average score: {category.stats.avgScore}</p>
                                      <p className="text-[10px] text-slate-400">Pass rate: {category.stats.passRate}</p>
                                    </div>
                                  )}
                                  ...
                                  {category.stats.dueThisQuarter && (
                                    <div className="ml-6 space-y-1">
                                      <p className="text-[10px] text-slate-400">Due this quarter: {category.stats.dueThisQuarter} deputies ({category.stats.dueNote})</p>
                                      <p className="text-[10px] text-slate-400">Sessions needed: {category.stats.sessionsNeeded}</p>
                                      <p className="text-[10px] text-slate-400">Instructor: {category.stats.instructor}</p>
                                    </div>
                                  )}
                                ...
                                <div>
                                  ...
                                  {(category.stats.expired > 0 || category.stats.overdue > 0) && (
                                    <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-3 mb-3">
                                        ...
                                        <div className="space-y-1 ml-6">
                                          {category.stats.expiredDeputies.map((dep, idx) => (
                                            <div key={idx} className="flex items-center gap-2">
                                              <p className="text-[10px] text-slate-400">{dep.name} ({dep.level}) - Expired {dep.expired}</p>
                                      ...
                                      {category.stats.overdueNote && (
                                        <p className="text-[10px] text-slate-400 ml-6">{category.stats.overdueNote}</p>
                                      )}
                                      {category.stats.expiredNote && (
                                        <p className="text-[10px] text-slate-400 ml-6">{category.stats.expiredNote}</p>
                                      )}
                                    </div>
                                  )}
                                  ...
                                  {category.stats.notRequired > 0 && (
                                    <div className="bg-slate-700/20 border border-slate-600/30 rounded-lg p-3 mb-3">
                                      <p className="text-xs text-slate-400">{category.stats.notRequired} {category.stats.notRequiredNote}</p>
                                    </div>
                                  )}
                                </div>
                              </div>
                            ...
                            {category.upcoming && (
                              <div className="mt-4">
                                <h5 className="text-xs font-semibold text-slate-300 mb-3">Upcoming Expirations:</h5>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                  <div className="bg-amber-500/5 border border-amber-500/20 rounded-lg p-3">
                                      ...
                                      <div className="space-y-2">
                                        {category.upcoming.within30.deputies.map((dep, idx) => (
                                          <div key={idx} className="text-[10px] text-slate-400">
                                            <p className="text-slate-300">{dep.name} <span className="text-slate-500">{dep.badge}</span></p>
                                    ...
                                    {category.upcoming.within30.note && (
                                      <p className="text-[10px] text-slate-400">{category.upcoming.within30.note}</p>
                                    )}
                                  </div>
                                  ...
                                  {category.upcoming.within90 && (
                                    <div className="bg-slate-700/20 border border-slate-600/30 rounded-lg p-3">
                                      <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-medium text-slate-400">61-90 days: {category.upcoming.within90.count}</span>
                                      </div>
                                      <button className="mt-2 text-[10px] text-slate-400 hover:text-slate-300 underline">View Full List</button>
                                    </div>
                                  )}
                                </div>
                              </div>
                            ...
                            {category.weaponBreakdown && (
                              <div className="mt-4">
                                <h5 className="text-xs font-semibold text-slate-300 mb-3">Qualification Breakdown by Weapon:</h5>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                  {category.weaponBreakdown.map((weapon, idx) => (
                                    <div key={idx} className="bg-slate-900/40 border border-slate-700/30 rounded-lg px-3 py-2">
                                      <p className="text-xs text-slate-300">{weapon.weapon}</p>
                            ...
                            {category.specializedQuals && (
                              <div className="mt-4">
                                <h5 className="text-xs font-semibold text-slate-300 mb-3">Specialized Firearms Qualifications:</h5>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                                  {category.specializedQuals.map((spec, idx) => (
                                    <div key={idx} className="bg-slate-900/40 border border-slate-700/30 rounded-lg px-3 py-2">
                                      <p className="text-xs text-slate-300">{spec.type}</p>
                            ...
                            {category.rangeDays && (
                              <div className="mt-4">
                                <h5 className="text-xs font-semibold text-slate-300 mb-3">Upcoming Range Days (2026 Schedule):</h5>
                                <div className="space-y-2">
                                  {category.rangeDays.map((day, idx) => (
                                    <div key={idx} className="flex items-center justify-between bg-slate-900/40 border border-slate-700/30 rounded-lg px-3 py-2">
                                      <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-xs text-slate-400">{day.purpose}</span>
                                      </div>
                            ...
                            {category.scheduledSessions && (
                              <div className="mt-4">
                                <h5 className="text-xs font-semibold text-slate-300 mb-3">Scheduled Training Sessions:</h5>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                  {category.scheduledSessions.map((session, idx) => (
                                    <div key={idx} className="bg-slate-900/40 border border-slate-700/30 rounded-lg px-3 py-2">
                                      ...
                                      <p className="text-[10px] text-slate-400 mt-1">Enrolled: {session.enrolled}/{session.slots} slots</p>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        {supportOpen && (
          <div className="absolute bottom-16 right-0 w-80 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl overflow-hidden">
            <div className="p-4 border-b border-slate-700/50">
              <h3 className="text-sm font-semibold text-white">Training Resources & Support</h3>
              <p className="text-xs text-slate-400 mt-1">GCSO Training Division</p>
            </div>
            <div className="p-4 space-y-3">
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">Training Coordinator</p>
                <p className="text-xs text-slate-400">Sgt. R. Martinez (Training Division)</p>
                <p className="text-xs text-amber-400 mt-1">Ext. 4521</p>
              </div>
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">Firearms Instructor</p>
                <p className="text-xs text-slate-400">Sgt. R. Martinez (Lead), Deputy K. Chen (Asst.)</p>
                <p className="text-xs text-amber-400 mt-1">Range: Ext. 4530</p>
              </div>
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">DT Instructor</p>
                <p className="text-xs text-slate-400">Deputy M. Johnson</p>
                <p className="text-xs text-amber-400 mt-1">Ext. 4525</p>
              </div>
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">GA POST Portal</p>
                <p className="text-xs text-slate-400">Georgia POST Council - Certification Renewal</p>
              </div>
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">GCSO Policies</p>
                <p className="text-xs text-slate-400">Policy 4.12 (Firearms), 4.15 (TASER), 3.14 (DT)</p>
              </div>
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">CJIS Security Policy</p>
                <p className="text-xs text-slate-400">FBI CJIS Security Policy v5.9.3</p>
              </div>
            </div>
          </div>
        )}

      ...
      <div className="p-5 lg:p-8 space-y-8 min-h-full">
          ...
          <div className="mb-6">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-4">
              <div>
                <h2 className="text-2xl lg:text-3xl font-bold text-primary mb-2">Social Media Analysis</h2>
                <p className="text-secondary mb-2">Public online presence, digital footprint, and professional conduct assessment</p>
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm">
              <span className="text-secondary">Total profiles analyzed: <span className="text-primary font-medium">{socialMediaReports.length} subjects</span></span>
              <span className="text-slate-500">|</span>
              <span className="text-secondary">Platforms reviewed: <span className="text-primary font-medium">Facebook, LinkedIn, Twitter/X, Instagram</span></span>
            </div>
          </div>
          ...
          <div className="bg-surface border border-border rounded-xl shadow-sm dark:shadow-none p-5 mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-base font-semibold text-primary">Social Media Review Status Summary</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-primary font-medium">{socialMediaReports.length} (across multiple cases)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400" />
                    <span className="text-secondary">Approved (no concerns):</span>
              ...
              <div>
                <h4 className="text-sm font-medium text-secondary mb-3">Review Guidelines</h4>
            ...
            <div className="mt-4 pt-4 border-t border-border">
              <h4 className="text-sm font-medium text-secondary mb-2">Important Notes on Social Media Review</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-secondary">
                <div className="bg-white dark:bg-zinc-950/40 rounded-lg p-3">
                  <p className="font-medium text-secondary mb-1">First Amendment Considerations</p>
                ...
                <div className="bg-white dark:bg-zinc-950/40 rounded-lg p-3">
                  <p className="font-medium text-secondary mb-1">Time Context Matters</p>
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === 'clear' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'bg-white dark:bg-zinc-900/40 text-secondary hover:text-slate-900 dark:hover:text-white border border-slate-700/50'}`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === 'progress' ? 'bg-blue-500/20 text-blue-400 border border-blue-500/30' : 'bg-white dark:bg-zinc-900/40 text-secondary hover:text-slate-900 dark:hover:text-white border border-slate-700/50'}`}
            >
              <span className="flex items-center gap-2">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                      {report.platforms.map((platform, idx) => (
                        <span key={idx} className={`px-2.5 py-1 rounded-lg text-xs font-medium ${
                          platform.posts > 0 ? 'bg-purple-500/10 text-purple-400' : 'bg-white dark:bg-zinc-800/50 text-slate-500'
                        }`}>
                    ...
                    <div className="border-t border-border p-5">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <span className="text-secondary ml-2">{report.reviewPeriod}</span>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <span className="text-secondary ml-2">{report.platforms.length} identified</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          {report.platforms.map((platform, idx) => (
                            <div key={idx} className="bg-white dark:bg-zinc-950/40 rounded-lg p-3">
                              <div className="flex items-center justify-between mb-2">
                                <span className="text-sm font-medium text-primary">{platform.name}</span>
                                <span className={`text-xs px-2 py-0.5 rounded ${platform.posts > 0 ? 'bg-green-500/20 text-green-400' : 'bg-white dark:bg-zinc-800/50 text-slate-500'}`}>
                              ...
                              {report.contentThemes.map((theme, idx) => (
                                <div key={idx}>
                                  <div className="flex items-center justify-between mb-1">
                                    <span className="text-sm text-secondary">{theme.theme}</span>
                                    <span className="text-sm text-secondary">{theme.percentage}%</span>
                                  </div>
                      ...
                      {report.politicalContent && (
                        <div className="mb-6">
                          ...
                          <div className={`rounded-xl p-4 ${report.politicalContent.isProtected ? 'bg-blue-500/10 border border-blue-500/30' : 'bg-white dark:bg-zinc-950/40'}`}>
                            <div className="flex items-center justify-between mb-2">
                              <span className="text-sm text-secondary">Political posts found:</span>
                              <span className="text-sm text-primary font-medium">{report.politicalContent.posts} of {report.politicalContent.totalPosts} posts</span>
                            </div>
                            <p className="text-sm text-secondary mb-2">{report.politicalContent.description}</p>
                      ...
                      {report.flaggedContent && report.flaggedContent.length > 0 && (
                        <div className="mb-6">
                              ...
                              <div key={idx} className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs mb-2">
                                  ...
                                  <div>
                                    ...
                                    <span className="text-secondary ml-1">{flagged.type}</span>
                                  </div>
                                </div>
                          ...
                          {/* Time Context */}
                          {report.timeContext && (
                            <div className="mt-4 bg-white dark:bg-zinc-950/60 rounded-lg p-4">
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                                ...
                                <div>
                                  ...
                                  <span className="text-secondary ml-1">{report.timeContext.subjectAgeAtTime}</span>
                                </div>
                                <div>
                                  <span className="text-slate-500">Time elapsed:</span>
                                  <span className="text-secondary ml-1">{report.timeContext.timeElapsed}</span>
                                </div>
                                <div>
                      ...
                      {report.recentBehavior && report.statusCategory === 'review' && (
                        <div className="mb-6">
                          ...
                          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                            ...
                            <p className="text-sm text-secondary">Assessment: {report.recentBehavior.assessment}</p>
                            <p className="text-xs text-secondary mt-1">Tone: {report.recentBehavior.tone}</p>

      ...
      <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="px-4 lg:px-6 py-4 flex items-center justify-between gap-4">
            <div className="flex items-center gap-4 flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-primary">Employee Records</span>
              </div>
            </div>
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              <button onClick={() => navigate(createPageUrl('NewHireOnboarding'))} className="hidden lg:flex items-center gap-2 px-3 py-2 bg-white dark:bg-slate-800/40 hover:bg-slate-100 dark:hover:bg-slate-800/60 border border-slate-700/50 text-secondary rounded-xl text-sm transition-all">
        ...
        <main className="flex-1 overflow-y-auto p-4 lg:p-6">
          <div className="max-w-7xl mx-auto">
            {/* GCSO Header */}
            <div className="mb-6">
              <h2 className="text-2xl lg:text-3xl font-bold text-primary mb-2">Personnel Records & Employee Information</h2>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-secondary">Duty weapon removed, desk duty assigned. Range day scheduled February 12, 2026. Written counseling pending.</p>
                  </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-secondary">Chen (Feb 15), Williams (Mar 20), Taylor (Mar 5), Garcia (May 1), Davis (deferred - medical leave)</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="mb-4 bg-white dark:bg-slate-800/40 border border-red-500/30 rounded-xl overflow-hidden">
                ...
                {expandedIssue.martinez && (
                  <div className="px-5 pb-5 border-t border-red-500/20">
                    ...
                    <div className="mt-4">
                      <h5 className="text-xs font-semibold text-secondary mb-3">Current Status:</h5>
              ...
              <div className="mb-4 bg-white dark:bg-slate-800/40 border border-amber-500/30 rounded-xl overflow-hidden">
                ...
                {expandedIssue.chen && (
                  <div className="px-5 pb-5 border-t border-amber-500/20">
                    ...
                    <div className="mt-4">
                      <h5 className="text-xs font-semibold text-secondary mb-3">Action Required:</h5>
                      <div className="space-y-2">
                        {[
              ...
              <div className="mb-6 bg-gradient-to-r from-violet-500/10 via-blue-500/10 to-cyan-500/10 border border-violet-500/20 rounded-xl p-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-white dark:bg-slate-900/40 rounded-lg p-3 border border-border">
                    ...
                    <p className="text-xs text-secondary">2 personnel with certification issues affecting operational readiness. Martinez (firearms expired, desk duty) and Chen (CIT expiring in 19 days, no renewal scheduled).</p>
                  ...
                  <div className="bg-white dark:bg-slate-900/40 rounded-lg p-3 border border-border">
                    ...
                    <p className="text-xs text-secondary">Overall compliance: 96.6% (172/178 fully compliant). Performance review completion: 100% on file. Average tenure: 6.4 years. 3 commendations in last 12 months.</p>
                    <div className="mt-2 flex items-center gap-1">
                      ...
                      <div key={employee.id} className={`grid grid-cols-[1fr_120px_140px_120px_100px_80px] gap-2 px-5 py-3 items-center border-b border-border dark:border-slate-700/30 hover:bg-slate-100 dark:hover:bg-slate-800/60 transition-colors ${
                        ...
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="min-w-0">
                            <p className="text-sm font-medium text-primary truncate">{employee.name}</p>
                            <p className="text-[10px] text-secondary truncate">{employee.position}</p>
                          </div>
                        </div>
                        <span className="text-xs text-secondary font-mono">{employee.badge}</span>
                        <span className="text-xs text-secondary truncate">{employee.department}</span>
                        ...
                        <div className="flex items-start justify-between gap-4 flex-wrap">
                          <div className="flex items-start gap-4 flex-1 min-w-0">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-secondary mb-1">{employee.position} • {employee.department}</p>

                              <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-secondary mb-2">
                                ...
                                <div className="mt-3 p-2 bg-slate-50 dark:bg-slate-900/30 rounded-lg">
                                  <div className="flex items-center justify-between text-xs">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span className="text-secondary">{employee.postCert.type} {employee.postCert.number}</span>
                                    </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-slate-900 border border-border rounded-2xl p-6 max-w-4xl w-full shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              {selectedEmployee.postCert && (
                <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                    <div><span className="text-slate-500">Type:</span> <span className="text-secondary">{selectedEmployee.postCert.type}</span></div>
                    <div><span className="text-slate-500">Number:</span> <span className="text-secondary">{selectedEmployee.postCert.number}</span></div>
                    <div><span className="text-slate-500">Issued:</span> <span className="text-secondary">{selectedEmployee.postCert.issued}</span></div>
              ...
              {/* All Certifications */}
              <div>
                <h4 className="text-sm font-semibold text-primary mb-3">Certifications & Qualifications</h4>
                <div className="space-y-2">
                  {selectedEmployee.certifications.map((cert, idx) => {
                    ...
                    return (
                      <div key={idx} className={`p-3 rounded-lg border ${certConfig.border} ${cert.status === 'expired' ? 'bg-red-500/5' : cert.status === 'expiring' ? 'bg-amber-500/5' : 'bg-slate-100/80 dark:bg-slate-800/30'}`}>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-[10px] text-secondary">
              ...
              <div className="bg-slate-100/80 dark:bg-slate-800/30 rounded-xl p-4 border border-slate-700/50">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-xs">
                  ...
                  <div><span className="text-slate-500">Evaluator:</span> <span className="text-secondary">{selectedEmployee.performance.evaluator}</span></div>
                  <div><span className="text-slate-500">Rating:</span> <span className="text-secondary">{selectedEmployee.performance.rating}</span></div>
                  <div><span className="text-slate-500">Review Period:</span> <span className="text-secondary">{selectedEmployee.performance.reviewPeriod}</span></div>
                  <div><span className="text-slate-500">Next Due:</span> <span className="text-secondary">{selectedEmployee.performance.nextDue}</span></div>
              ...
              <div className="bg-slate-100/80 dark:bg-slate-800/30 rounded-xl p-4 border border-slate-700/50">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div><span className="text-slate-500">Specialized Training:</span> <span className="text-secondary">{selectedEmployee.personnelSummary.specializedTraining.join(', ')}</span></div>
                </div>
              </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        {supportOpen && (
          <div className="absolute bottom-16 right-0 w-80 bg-surface-raised backdrop-blur-xl border border-border rounded-2xl shadow-2xl overflow-hidden">
            <div className="p-4 border-b border-border">
              <h3 className="text-sm font-semibold text-primary">Personnel Records Support</h3>

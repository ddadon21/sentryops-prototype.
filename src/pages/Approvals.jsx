                                ...
                                {approval.documents && approval.documents.length > 0 && (
                                  <div className="flex items-center gap-2 flex-wrap">
                                    ...
                                    {approval.documents.map((doc, idx) => (
                                      <button
                                        key={idx}
                                        className="flex items-center gap-1 px-1.5 py-0.5 bg-slate-800/30 hover:bg-slate-700/30 border border-slate-700/15 rounded text-[10px] text-slate-300 transition-colors"
                                      >

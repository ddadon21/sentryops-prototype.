        ...
        <div className="max-w-[1300px] mx-auto">
          ...
          {activeTab === 'pending' && (
            <>
              ...
              {selectedItems.length > 0 && (
                <div className="mb-3 flex items-center gap-2 px-3 py-2 bg-slate-50 dark:bg-zinc-900/35 border border-border rounded flex-wrap">
          ...
          {activeTab === 'decision-log' && (
            <>
              ...
              <div className="border border-border dark:border-slate-700/30 rounded overflow-x-auto">

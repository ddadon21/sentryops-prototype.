                    ...
                    <div className="bg-slate-900/40 rounded-lg p-4 border border-slate-700/30">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                        <div className="flex items-start gap-2">
                          ...
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">Age:</span> 21+ years (Georgia POST requirement)</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">Education:</span> High school diploma or GED</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">Certification:</span> Georgia POST Basic Law Enforcement OR academy eligible</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">Driver's License:</span> Valid GA license, clean record</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">Background:</span> Must pass POST-compliant investigation</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">Physical:</span> GCSO fitness test (1.5-mi run, push-ups, sit-ups)</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-slate-900/40 rounded-lg p-4 border border-slate-700/30">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">POST Cert:</span> Georgia POST Basic Law Enforcement - REQUIRED</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">Experience:</span> 3+ years sworn law enforcement</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">Skills:</span> Report writing, interview techniques, records research</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <span className="text-slate-700 dark:text-slate-300"><span className="text-white font-medium">Clearances:</span> GCIC/NCIC access, CJIS security</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-3 p-3 bg-red-500/10 border border-red-500/30 rounded-lg">
                        ...
                        <span className="text-sm text-slate-700 dark:text-slate-300"><span className="font-bold text-white">EXTEND POSTING</span> to March 31, 2026 (need more time)</span>
                      </div>
                      <div className="flex items-start gap-3 p-3 bg-red-500/10 border border-red-500/30 rounded-lg">
                        ...
                        <span className="text-sm text-slate-700 dark:text-slate-300"><span className="font-bold text-white">INCREASE SALARY</span> to $42,000-50,000 (match county departments)</span>
                      </div>
                      <div className="flex items-start gap-3 p-3 bg-red-500/10 border border-red-500/30 rounded-lg">
                        ...
                        <span className="text-sm text-slate-700 dark:text-slate-300"><span className="font-bold text-white">REDUCE EXPERIENCE</span> requirement to 1-2 years (from 2+)</span>
                      </div>
                      <div className="flex items-start gap-3 p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg">
                        ...
                        <span className="text-sm text-slate-700 dark:text-slate-300"><span className="font-bold text-white">EXPAND MARKETING:</span> Indeed.com, LinkedIn, Gwinnett County Jobs, local colleges</span>
                      </div>
                      <div className="flex items-start gap-3 p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg">
                        ...
                        <span className="text-sm text-slate-700 dark:text-slate-300"><span className="font-bold text-white">REQUEST BUDGET APPROVAL</span> from Sheriff Taylor for salary increase</span>
                      </div>
                    </div>
                  </div>
      ...
      {chatOpen && (
        <div className="fixed bottom-24 right-6 w-full max-w-96 h-[500px] bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl flex flex-col z-40 mx-4 sm:mx-0">
          ...
          <div className="p-4 border-t border-slate-700/50">
            <div className="flex items-center gap-2">
              <input type="text" placeholder="Ask about GCSO recruitment..." className="flex-1 px-4 py-2 bg-white dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50" />

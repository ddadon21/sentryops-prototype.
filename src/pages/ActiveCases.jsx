...
export default function ActiveCases() {
  ...
  const getPriorityDisplay = (priority) => {
    switch (priority) {
      ...
      case 'on_hold': return { label: 'ON HOLD', color: 'bg-slate-500/20 text-slate-400 border-slate-500/30' };
          ...
          <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-base font-semibold text-white">CASELOAD SUMMARY</h4>
                      <button
                      ...
                      <div>
                        ...
                        <div className="space-y-1.5 text-sm">
                          <div className="flex items-center justify-between">
                            <span className="text-slate-400">Assigned to investigators</span>
                            <span className="text-slate-300">{summaryStats.totalActive} cases</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="text-slate-400">Requiring supervisor action</span>
                            <span className="text-amber-400">{summaryStats.requireingSupervisor} cases</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="text-slate-400">On hold (external response)</span>
                            <span className="text-slate-400">{summaryStats.onHold} cases</span>
                          </div>
                          <div className="flex items-center justify-between">
                      ...
                      <div>
                        ...
                        <div className="space-y-1.5 text-sm">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-slate-300">&lt;18 days</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="text-slate-400">Longest case</span>
                            <span className="text-red-400">{summaryStats.longestCase} days (on hold)</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="text-slate-400">Shortest case</span>
                        ...
                        <div className="space-y-1.5 text-sm">
                          {investigatorWorkload.map((inv, idx) => (
                            <div key={idx} className="flex items-center justify-between">
                              ...
                              <span className="text-slate-300">{inv.cases} cases</span>
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            <div className="mb-6 bg-slate-800/40 border border-slate-700/50 rounded-xl p-4 lg:p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-sm font-semibold text-white uppercase">Search Active Cases</h3>
                ...
                <div className="lg:col-span-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-slate-900/40 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/50"
                    />
                  </div>
                </div>
                <div>
                  <select
                    ...
                    className="w-full px-4 py-2.5 bg-slate-900/40 border border-slate-700/50 rounded-xl text-white focus:outline-none focus:border-amber-500/50 text-sm"
                  >
              ...
              <div className="mt-4 pt-4 border-t border-slate-700/30 flex items-center justify-between flex-wrap gap-3">
                <p className="text-sm text-slate-400">Showing: <span className="text-white font-medium">{filteredCases.length} of {cases.length}</span> cases</p>
                <div className="flex items-center gap-2">
                    ...
                    <div className="p-5">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-3">
                          <h3 className="text-lg font-semibold text-white">{case_item.subject}</h3>
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-300">{case_item.applicationDate}</p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-300">Agent {case_item.investigator}</p>
                        </div>
                      </div>
                      ...
                      {case_item.priorityReason && (
                        <div className="mb-4 p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
                          ...
                          <p className="text-sm text-slate-300 mt-1">{case_item.priorityReason}</p>
                        </div>
                      )}
                      ...
                      <div className="mb-4">
                        <div className="flex items-center gap-2 mb-2">
                          <Clock className="w-4 h-4 text-amber-400" />
                          <span className="text-sm font-semibold text-white">CURRENT STATUS:</span>
                          <span className="text-sm text-amber-400 font-medium">{case_item.status}</span>
                        </div>
                        <p className="text-xs text-slate-400">Last Activity: {case_item.lastActivity} — {case_item.lastUpdate}</p>
                      </div>

                      {/* Investigation Stages */}
                      <div className="mb-4">
                        <p className="text-xs font-semibold text-slate-400 uppercase mb-3">Investigation Stages</p>
                      ...
                      <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg mb-4">
                        ...
                        <p className="text-sm text-slate-300">{case_item.nextAction}</p>
                      </div>
                      ...
                      {case_item.blockers && (
                        <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg mb-4">
                          ...
                          <p className="text-sm text-slate-300">{case_item.blockers}</p>
                        </div>
                      )}
                      ...
                      {case_item.holdReason && (
                        <div className="p-3 bg-slate-700/30 border border-slate-600/30 rounded-lg mb-4">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-xs font-semibold text-slate-400 uppercase">Hold Reason</span>
                          </div>
                          <p className="text-sm text-slate-300">{case_item.holdReason}</p>
                          {case_item.contactAttempts && (
                            <div className="mt-2 pt-2 border-t border-slate-600/30">
                              ...
                              {case_item.contactAttempts.map((attempt, idx) => (
                                <p key={idx} className="text-xs text-slate-400">• {attempt}</p>
                              ))}
                            </div>
                          )}
                        </div>
                          ...
                          <div className="space-y-2">
                            {case_item.documentedConcerns.map((concern, idx) => (
                              <div key={idx} className="text-sm">
                                <p className="text-slate-300"><span className="text-amber-400 font-medium">{concern.type}:</span> {concern.detail}</p>
                      ...
                      {case_item.recommendation && (
                        <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg mb-4">
                          ...
                          <p className="text-sm text-slate-300">{case_item.recommendation}</p>
                        </div>
                      )}
                      ...
                      {case_item.extendedReason && (
                        <div className="p-3 bg-slate-700/30 border border-slate-600/30 rounded-lg mb-4">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-xs font-semibold text-slate-400 uppercase">Reason for Extended Timeline</span>
                          </div>
                          <p className="text-sm text-slate-300">{case_item.extendedReason}</p>
                        </div>
                      )}
                      ...
                      {case_item.lateralNotes && (
                        <div className="p-3 bg-purple-500/10 border border-purple-500/20 rounded-lg mb-4">
                          ...
                          <p className="text-sm text-slate-300">{case_item.lateralNotes}</p>
                        </div>
                      )}
                      ...
                      {case_item.notes && (
                        <div className="p-3 bg-slate-700/30 border border-slate-600/30 rounded-lg mb-4">
                          ...
                          <p className="text-sm text-slate-300">{case_item.notes}</p>
                        </div>
                      )}
        ...
        <div className="fixed bottom-24 right-6 w-full max-w-96 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl flex flex-col z-40 mx-4 sm:mx-0">
          <div className="p-4 border-b border-slate-700/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-white">Case Management Resources</h3>
          ...
          <div className="p-4 space-y-3">
            ...
            <button className="w-full flex items-center gap-3 p-3 bg-slate-800/40 hover:bg-slate-800/60 rounded-xl transition-all text-left">
              ...
              <div>
                <p className="text-sm text-white font-medium">Case Checklists</p>
                <p className="text-xs text-slate-500">Stage-by-stage requirements</p>
              </div>
            </button>
            <button className="w-full flex items-center gap-3 p-3 bg-slate-800/40 hover:bg-slate-800/60 rounded-xl transition-all text-left">
              <Users className="w-5 h-5 text-purple-400" />
              <div>
                <p className="text-sm text-white font-medium">Reassign Cases</p>
                <p className="text-xs text-slate-500">Transfer to another investigator</p>
              </div>
            </button>
            <button className="w-full flex items-center gap-3 p-3 bg-slate-800/40 hover:bg-slate-800/60 rounded-xl transition-all text-left">
              <Scale className="w-5 h-5 text-amber-400" />
              <div>
                <p className="text-sm text-white font-medium">Adjudication Guidelines</p>
                <p className="text-xs text-slate-500">Decision criteria reference</p>
              </div>
            </button>
          </div>
        </div>

            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                <div className="bg-slate-800/60 p-3 rounded-xl">
                  <p className="text-sm text-slate-200">Hi! I can help you configure integrations, manage API keys, explain security settings, troubleshoot connections, and optimize your SentryOps experience. What do you need help with?</p>
                </div>
              </div>
            </div>
          </div>

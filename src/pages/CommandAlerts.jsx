    ...
    <DashboardLayout>
      <div className="p-5 lg:p-7">
        <div className="max-w-[1200px] mx-auto">
              ...
              return (
                <div
                  ...
                  className={`rounded border transition-colors ${
                    isResolved
                      ? 'border-border bg-slate-50 dark:bg-slate-800/[0.06] opacity-30'
                      : isAcknowledged
                ...
                >
                  ...
                  {isExpanded && (
                    <div className="border-t border-border dark:border-slate-700/30 ml-[22px]">
                      ...
                      {!isResolved && (
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-slate-100 dark:bg-slate-700/20 border-b border-border dark:border-slate-700/20">
                          {/* Consequence */}
                          <div className="px-3 py-2 bg-white dark:bg-slate-800/15">
                          ...
                          <div className="px-3 py-2 bg-white dark:bg-slate-800/15">
                            ...
                            <div className="mb-1">
                              ...
                              {ttr.pct !== undefined && (
                                <div className="w-full bg-slate-200 dark:bg-slate-700/50 rounded-full h-1">
                          ...
                          <div className="flex items-center gap-1.5 pt-1.5 border-t border-border">
                            {!isAcknowledged && (
                              <button
                                ...
                                className="px-2.5 py-1 text-[10px] font-medium text-secondary border border-border hover:bg-slate-100 dark:hover:bg-slate-700/20 rounded transition-colors"
                              >
                                Acknowledge
                              </button>
                            )}
          ...
          <div className="mt-4 px-4 py-2 bg-slate-50 dark:bg-slate-800/[0.06] border border-border dark:border-slate-800/20 rounded flex items-center gap-4 flex-wrap">

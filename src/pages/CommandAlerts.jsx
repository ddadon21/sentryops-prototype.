...
import { Home, Users, FileText, LayoutDashboard, TrendingUp, AlertCircle, Settings, Bell, MessageCircle, Search, ChevronRight, DollarSign, CheckCircle, Shield, Sparkles, X, Send, Menu, ChevronLeft, LogOut, Filter, Clock, MapPin, Phone, Mail, ExternalLink, AlertTriangle, Info, CheckCircle2, XCircle, Zap, Calendar, User, FileWarning, Building2, Radio, Target, Download, ChevronDown, Eye, UserPlus, Link2 } from 'lucide-react';
...
export default function CommandAlerts() {
  ...
  const navigation = [
    ...
    { id: 'alerts', label: 'Command Alerts', icon: AlertCircle, badge: '12', route: '/command/alerts' },
          ...
          <div className="px-4 lg:px-6 py-4 flex items-center justify-between gap-4">
            <div className="flex items-center gap-4 flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-white">Command Alerts</span>
              </div>
            </div>

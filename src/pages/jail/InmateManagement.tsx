      ...
      <div className="p-4 lg:p-6">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400">Current Population: {stats.total} Inmates</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-5 gap-4 mb-6">
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
            <div className="text-sm text-slate-400 mb-1">Total Inmates</div>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
            <div className="text-sm text-slate-400 mb-1">Medical</div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-slate-900 border-b border-slate-700">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase">Inmate ID</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase">Name</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase">DOB/Age</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase">Booking Date</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase">Charges</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase">Bond</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase">Classification</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase">Housing</th>
                ...
                {filteredInmates.map((inmate) => (
                  <tr key={inmate.id} className="hover:bg-slate-700/50 transition-colors">
                    ...
                    <td className="px-4 py-4">
                      ...
                      <div className="text-xs text-slate-400">{inmate.race} {inmate.gender}</div>
                    </td>
                    <td className="px-4 py-4 text-sm">
                      <div className="text-white">{inmate.dob}</div>
                      <div className="text-xs text-slate-400">Age: {inmate.age}</div>
                    </td>
                    <td className="px-4 py-4 text-sm">
                      <div className="text-white">{inmate.bookingDate}</div>
                      <div className="text-xs text-slate-400">{inmate.bookingTime}</div>
                    </td>
                    <td className="px-4 py-4 text-sm">
                    ...
                    <td className="px-4 py-4 text-sm">
                      ...
                      {inmate.bondAmount && inmate.bondAmount > 0 && (
                        <div className="text-xs text-slate-400">${inmate.bondAmount.toLocaleString()}</div>
                      )}
                    </td>
                    <td className="px-4 py-4 text-sm">
                    ...
                    <td className="px-4 py-4 text-sm">
                      ...
                      <div className="text-xs text-slate-400">Cell {inmate.cell}</div>
                    </td>
                    <td className="px-4 py-4">
                      <button
                        onClick={() => {
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="sticky top-0 bg-slate-800 border-b border-slate-700 p-6 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-slate-400">Inmate ID: {selectedInmate.id}</p>
                </div>
                <button
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 bg-slate-900/50 border border-slate-700 rounded-lg p-4">
                    ...
                    <div>
                      <div className="text-sm text-slate-400">Race / Gender</div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 bg-slate-900/50 border border-slate-700 rounded-lg p-4">
                    <div>
                      <div className="text-sm text-slate-400">Booking Number</div>
                      <div className="text-amber-400 font-mono">{selectedInmate.bookingNumber}</div>
                    </div>
                    <div>
                      <div className="text-sm text-slate-400">Booking Date/Time</div>
                      <div className="text-white font-medium">{selectedInmate.bookingDate} {selectedInmate.bookingTime}</div>
                    </div>
                    <div>
                      <div className="text-sm text-slate-400">Arresting Agency</div>
                      ...
                      <div key={idx} className="bg-slate-900/50 border border-slate-700 rounded-lg p-4">
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-slate-400">Statute: {charge.statute}</div>
                          </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 bg-slate-900/50 border border-slate-700 rounded-lg p-4">
                    ...
                    <div>
                      <div className="text-sm text-slate-400">Housing Assignment</div>
                ...
                {selectedInmate.nextCourtDate && (
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 bg-slate-900/50 border border-slate-700 rounded-lg p-4">
                      <div>
                        <div className="text-sm text-slate-400">Next Court Date</div>
                        <div className="text-white font-medium">{selectedInmate.nextCourtDate}</div>
                      </div>
                      <div>
                        <div className="text-sm text-slate-400">Court Type</div>

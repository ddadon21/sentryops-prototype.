      ...
      <div className="p-4 lg:p-6">
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            <Hospital className="w-8 h-8 text-amber-700" />
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white">Medical Management</h1>
              <p className="text-slate-700 dark:text-slate-400">Inmate Health Services & Medical Monitoring</p>
            </div>
          </div>
        </div>
        <div className="mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div>
                  ...
                  <div className="text-slate-700 dark:text-slate-400 text-xs mt-1">Anderson, R. - Gwinnett Medical</div>
                </div>
                <div>
                  ...
                  <div className="text-slate-700 dark:text-slate-400 text-xs mt-1">24/7 one-on-one observation</div>
                </div>
                <div>
                  ...
                  <div className="text-slate-700 dark:text-slate-400 text-xs mt-1">Infectious disease protocol</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div key={record.inmateId} className="bg-slate-800 border-2 border-red-500/30 rounded-lg p-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div>
                        ...
                        <span className="text-amber-700 font-mono">{record.inmateId}</span>
                      </div>
                      <div>
                      ...
                      <div>
                        <span className="text-slate-700 dark:text-slate-400">Age:</span>{' '}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-slate-700 dark:text-slate-400">Last seen: {record.lastSeen}</div>
                  </div>
                </div>
              </div>
            ))}
                ...
                {medicationSchedule.map((round, idx) => (
                  <div key={idx} className="bg-white dark:bg-slate-900/50 border border-slate-700 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="text-right">
                        <div className="text-sm text-slate-700 dark:text-slate-400">Nurse</div>
                        <div className="text-slate-900 dark:text-white font-medium">{round.nurse}</div>
                      </div>
                    </div>
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div>
                        <span className="text-slate-700 dark:text-slate-400">Total Inmates:</span>{' '}
                        <span className="text-slate-900 dark:text-white font-semibold">{round.inmates}</span>
                      </div>
                      <div>
                        <span className="text-slate-700 dark:text-slate-400">Administered:</span>{' '}
                        <span className="text-emerald-400 font-semibold">{round.administered}</span>
                      </div>
                      <div>
                        <span className="text-slate-700 dark:text-slate-400">Refused:</span>{' '}
            ...
            {chronicCases.map((record, idx) => (
              <div key={idx} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
                ...
                <div className="flex items-center justify-between text-sm">
                  <div>
                    <span className="text-slate-700 dark:text-slate-400">Next Check:</span>{' '}
                    <span className="text-slate-900 dark:text-white font-medium">{record.nextCheck}</span>
                  </div>
                  <div>
                    <span className="text-slate-700 dark:text-slate-400">Last Reading:</span>{' '}

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="px-4 lg:px-6 py-4 flex items-center justify-between gap-4">
            <div className="flex items-center gap-4 flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 text-sm">
                <button onClick={() => navigate(createPageUrl('HRDashboard'))} className="text-slate-400 hover:text-white transition-colors">HR Dashboard</button>
            ...
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              <button onClick={() => setShowCoverageModal(true)} className="hidden md:flex items-center gap-2 px-3 py-2 bg-slate-800/40 hover:bg-slate-800/60 border border-slate-700/50 text-slate-300 rounded-xl text-sm transition-all">
                <BarChart3 className="w-4 h-4" />
                <span>Coverage Analysis</span>
              </button>
              <button onClick={() => setShowFMLADashboard(true)} className="hidden lg:flex items-center gap-2 px-3 py-2 bg-slate-800/40 hover:bg-slate-800/60 border border-slate-700/50 text-slate-300 rounded-xl text-sm transition-all">
                ...
                {notificationsOpen && (
                  <div className="absolute right-0 top-full mt-2 w-96 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-xl shadow-2xl z-50">
                    <div className="p-4 border-b border-slate-700/50">
                      <h3 className="text-sm font-semibold text-white">Personnel Notifications</h3>
                    </div>
        ...
        <main className="flex-1 overflow-y-auto p-4 lg:p-6">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Page Title Section */}
            <div className="mb-6">
              <h2 className="text-2xl lg:text-3xl font-bold text-white mb-2">Leave Request Management & Shift Coverage Planning</h2>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
              ...
              <div className="bg-slate-800/40 border border-red-500/30 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="text-xs text-slate-400">FMLA Requests</p>
                </div>
              ...
              <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="text-xs text-slate-400">Upcoming Absences</p>
                </div>
              ...
              <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="text-xs text-slate-400">Denied Requests</p>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">FMLA designation notice (WH-382) due by November 07, 2024. Federal law requires employer response within 5 business days of receiving medical certification.</p>
                  </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">Marcus Chen (C-Shift, Dec 14-21), Robert Martinez (A-Shift, Nov 18-19), Daniel Wilson (A-Shift, Nov 22). All shifts maintain minimum staffing. Pending supervisor review.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">Sarah Williams (D-Shift, Nov 5-7) - conflicts with K. Martinez same dates. Jennifer Taylor (B-Shift, Nov 25-29) - below minimum staffing for Thanksgiving week.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">November 25-29, 2024: B-Shift currently 1 deputy below minimum staffing. Coordinate overtime or temporary reassignment to maintain coverage.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-white">FMLA Leave Requests - Federal Law Compliance</h3>
              ...
              <div className="bg-slate-800/40 border border-red-500/30 rounded-xl overflow-hidden">
                <button onClick={() => setExpandedFMLA(!expandedFMLA)} className="w-full px-5 py-4 flex items-center justify-between hover:bg-slate-800/60 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <div className="flex items-center gap-2 flex-wrap">
                        <h4 className="text-sm font-semibold text-white">AMANDA GARCIA</h4>
                      ...
                      <p className="text-xs text-slate-400 mt-0.5">Employee ID: BI-9012 | Background Investigator | Human Resources</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {expandedFMLA ? <ChevronUp className="w-4 h-4 text-slate-400" /> : <ChevronDown className="w-4 h-4 text-slate-400" />}
                  </div>
                </button>
                ...
                {expandedFMLA && (
                  <div className="px-5 pb-5 border-t border-red-500/20 space-y-4">
                    ...
                    <div className="bg-slate-900/40 border border-slate-700/30 rounded-lg p-4">
                      <h5 className="text-xs font-semibold text-slate-300 mb-3">Leave Request Details</h5>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-2">
                          ...
                          <div className="text-xs text-slate-400">
                            <span className="text-slate-300 font-medium">Employment Duration:</span> Hired October 31, 2021 (3 years). Requirement: 12+ months of employment.
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <div className="text-xs text-slate-400">
                            <span className="text-slate-300 font-medium">Hours Worked:</span> 2,184 hours in preceding 12 months. Requirement: 1,250+ hours worked.
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                          <div className="text-xs text-slate-400">
                            <span className="text-slate-300 font-medium">Employer Size:</span> 178 employees, all within 75-mile radius. Requirement: 50+ employees within 75 miles.
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-slate-900/40 border border-slate-700/30 rounded-lg p-4">
                      <h5 className="text-xs font-semibold text-slate-300 mb-3">Medical Certification (WH-380)</h5>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-slate-400">
                    ...
                    <div className="bg-slate-900/40 border border-slate-700/30 rounded-lg p-4">
                      <h5 className="text-xs font-semibold text-slate-300 mb-3">FMLA Entitlement Tracking</h5>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-slate-400 mb-3">
                    ...
                    <div className="bg-slate-900/40 border border-slate-700/30 rounded-lg p-4">
                      <h5 className="text-xs font-semibold text-slate-300 mb-3">Operational Impact Assessment</h5>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-slate-400">
                    ...
                    <div className="bg-slate-900/40 border border-green-500/30 rounded-lg p-4">
                      ...
                      <h6 className="text-xs font-semibold text-slate-300 mb-3">Required Actions Checklist:</h6>
                      <div className="space-y-2">
                        {[
                    ...
                    <div className="flex flex-wrap gap-2 pt-2">
                      ...
                      <button className="px-3 py-2 bg-slate-700/40 hover:bg-slate-700/60 border border-slate-600/50 text-slate-300 rounded-lg text-xs font-medium transition-all flex items-center gap-2">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-white">Pending Leave Requests - Supervisor Review Required</h3>
              ...
              <div className="mb-4 flex flex-col sm:flex-row gap-3">
                <div className="flex gap-2">
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-xs font-medium transition-all ${requestFilter === 'all' ? 'bg-blue-500/20 border border-blue-500/30 text-blue-400' : 'bg-slate-800/40 border border-slate-700/50 text-slate-400 hover:text-white'}`}
                  >
                    All Requests
                  </button>
                  <button
                    onClick={() => setRequestFilter('approve')}
                    className={`px-3 py-2 rounded-lg text-xs font-medium transition-all ${requestFilter === 'approve' ? 'bg-green-500/20 border border-green-500/30 text-green-400' : 'bg-slate-800/40 border border-slate-700/50 text-slate-400 hover:text-white'}`}
                  >
                    Ready to Approve
                  </button>
                  <button
                    onClick={() => setRequestFilter('review')}
                    className={`px-3 py-2 rounded-lg text-xs font-medium transition-all ${requestFilter === 'review' ? 'bg-amber-500/20 border border-amber-500/30 text-amber-400' : 'bg-slate-800/40 border border-slate-700/50 text-slate-400 hover:text-white'}`}
                  >
                    Needs Review
                  </button>
                </div>
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-slate-800/40 border border-slate-700/50 rounded-xl text-white text-sm placeholder-slate-500 focus:outline-none focus:border-amber-500/50"
                  />
                </div>
                <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="px-3 py-2 bg-slate-800/40 border border-slate-700/50 rounded-xl text-white text-sm focus:outline-none focus:border-amber-500/50 cursor-pointer">
                  ...
                  <div key={request.id} className={`bg-slate-800/40 border rounded-xl overflow-hidden ${request.coverageStatus === 'conflict' ? 'border-amber-500/30' : 'border-slate-700/50'}`}>
                    <button onClick={() => toggleRequest(request.id)} className="w-full px-5 py-4 flex items-center justify-between hover:bg-slate-800/60 transition-colors">
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="text-left flex-1 min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            <h4 className="text-sm font-semibold text-white">{request.name.toUpperCase()}</h4>
                            <span className="px-2 py-0.5 bg-slate-700/50 rounded text-[10px] text-slate-300 font-mono">{request.badge}</span>
                          ...
                          <p className="text-xs text-slate-400 mt-0.5">{request.position} | {request.department} | {request.shift} ({request.shiftHours})</p>
                      ...
                      <div className="flex items-center gap-3 flex-shrink-0">
                        ...
                        {expandedRequests[request.id] ? <ChevronUp className="w-4 h-4 text-slate-400" /> : <ChevronDown className="w-4 h-4 text-slate-400" />}
                      </div>
                    </button>
                    ...
                    {expandedRequests[request.id] && (
                      <div className="px-5 pb-5 border-t border-slate-700/30 space-y-4">
                        ...
                        {/* Leave Balance */}
                        <div className="bg-slate-900/40 border border-slate-700/30 rounded-lg p-4">
                          <h5 className="text-xs font-semibold text-slate-300 mb-3">Leave Balance</h5>
                          <div className="grid grid-cols-3 gap-3 text-center mb-3">
                            <div>
                              <p className="text-lg font-bold text-white">{request.balance.available}h</p>
                        ...
                        <div className={`border rounded-lg p-4 ${
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-5 gap-3 text-center mb-3">
                            <div>
                              <p className="text-lg font-bold text-white">{request.shiftCoverage.normal}</p>
                          ...
                          {request.conflicts.length > 0 && (
                            <div className="mt-3 bg-amber-500/5 border border-amber-500/20 rounded-lg p-3">
                              ...
                              {request.conflicts.map((conflict, idx) => (
                                <div key={idx} className="flex items-start gap-2 text-xs text-slate-400 mb-1">
                            ...
                            <div className="space-y-2">
                              {request.resolutionOptions.map((option, idx) => (
                                <div key={idx} className="flex items-start gap-3 px-3 py-2 rounded-lg bg-slate-900/30">
                                  ...
                                  <p className="text-xs text-slate-300">{option}</p>
                                </div>
                              ))}
                            </div>
                          </div>
                        ...
                        {/* Operational Notes */}
                        <div className="bg-slate-900/40 border border-slate-700/30 rounded-lg p-4">
                          <h5 className="text-xs font-semibold text-slate-300 mb-3">Operational Assessment</h5>
                        ...
                        {/* Supervisor Status */}
                        <div className="bg-slate-900/40 border border-slate-700/30 rounded-lg p-4">
                          <h5 className="text-xs font-semibold text-slate-300 mb-2">Supervisor Review</h5>
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-white">Recently Denied Requests</h3>
              </div>
                ...
                <div className="px-5 py-4">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2 flex-wrap">
                          <h4 className="text-sm font-semibold text-white">DEPUTY T. BROOKS</h4>
                          <span className="px-2 py-0.5 bg-slate-700/50 rounded text-[10px] text-slate-300 font-mono">D-3890</span>
                          <span className="px-2 py-0.5 bg-red-500/20 border border-red-500/30 rounded text-[10px] text-red-400 font-bold">DENIED</span>
                        </div>
                        <p className="text-xs text-slate-400 mt-0.5">Deputy Sheriff | Patrol Division | B-Shift (14:00-02:00)</p>
      ...
      {showApproveModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900 border border-green-500/30 rounded-2xl p-6 max-w-md w-full shadow-2xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">{showApproveModal.name} - {showApproveModal.leaveType}</p>
              </div>
            </div>
            ...
            <div className="mb-4">
              <label className="text-xs text-slate-400 block mb-2">Comments (optional):</label>
              <textarea
                value={approveComment}
                onChange={(e) => setApproveComment(e.target.value)}
                placeholder="Add any notes for the supervisor..."
                className="w-full px-3 py-2 bg-slate-800/40 border border-slate-700/50 rounded-xl text-white text-sm placeholder-slate-500 focus:outline-none focus:border-green-500/50 resize-none h-20"
              />
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900 border border-red-500/30 rounded-2xl p-6 max-w-md w-full shadow-2xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">Deny Leave Request</h3>
                <p className="text-sm text-slate-400">{showDenyModal.name} - {showDenyModal.leaveType}</p>
              </div>
            </div>
            ...
            <div className="mb-4">
              <label className="text-xs text-slate-400 block mb-2">Denial Reason (required):</label>
              <select
                value={denyReason}
                onChange={(e) => setDenyReason(e.target.value)}
                className="w-full px-3 py-2 bg-slate-800/40 border border-slate-700/50 rounded-xl text-white text-sm focus:outline-none focus:border-red-500/50 cursor-pointer mb-3"
              >
              ...
              <label className="text-xs text-slate-400 block mb-2">Additional Comments:</label>
              <textarea
                value={denyComment}
                onChange={(e) => setDenyComment(e.target.value)}
                placeholder="Provide details for the denial..."
                className="w-full px-3 py-2 bg-slate-800/40 border border-slate-700/50 rounded-xl text-white text-sm placeholder-slate-500 focus:outline-none focus:border-red-500/50 resize-none h-20"
              />
            </div>
            <div className="flex gap-3">
      ...
      {showRequestInfoModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900 border border-blue-500/30 rounded-2xl p-6 max-w-md w-full shadow-2xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">{showRequestInfoModal.name} - {showRequestInfoModal.leaveType}</p>
              </div>
            </div>
            <div className="mb-4">
              <label className="text-xs text-slate-400 block mb-2">Information Needed:</label>
              <textarea
                value={requestInfoText}
                onChange={(e) => setRequestInfoText(e.target.value)}
                placeholder="Describe the additional information needed from the employee..."
                className="w-full px-3 py-2 bg-slate-800/40 border border-slate-700/50 rounded-xl text-white text-sm placeholder-slate-500 focus:outline-none focus:border-blue-500/50 resize-none h-24"
              />
            </div>
            <div className="flex gap-3">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900 border border-slate-700/50 rounded-2xl p-6 max-w-3xl w-full shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-start justify-between mb-6">
              <div>
                <h3 className="text-xl font-bold text-white mb-1">Shift Coverage Analysis</h3>
                <p className="text-sm text-slate-400">Current staffing levels and leave impact by shift</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-800/40 border border-green-500/30 rounded-xl p-4">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-semibold text-white">A-Shift (06:00-18:00)</h4>
              ...
              <div className="bg-slate-800/40 border border-red-500/30 rounded-xl p-4">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-semibold text-white">B-Shift (14:00-02:00)</h4>
              ...
              <div className="bg-slate-800/40 border border-green-500/30 rounded-xl p-4">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-semibold text-white">C-Shift (18:00-06:00)</h4>
                  <span className="px-2 py-0.5 bg-green-500/20 border border-green-500/30 rounded text-[10px] text-green-400 font-bold">ADEQUATE</span>
                </div>
                <div className="grid grid-cols-3 gap-2 text-center mb-3">
                  <div>
              ...
              <div className="bg-slate-800/40 border border-amber-500/30 rounded-xl p-4">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-semibold text-white">D-Shift (14:00-02:00)</h4>
      ...
      {showFMLADashboard && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900 border border-slate-700/50 rounded-2xl p-6 max-w-3xl w-full shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-start justify-between mb-6">
              <div>
                <h3 className="text-xl font-bold text-white mb-1">FMLA Dashboard</h3>
                <p className="text-sm text-slate-400">Family and Medical Leave Act tracking and compliance</p>
              </div>
            ...
            <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-4 mb-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-white">Amanda Garcia</h4>
                  <p className="text-xs text-slate-400">BI-9012 | Background Investigator | FMLA - Serious Health Condition</p>
                </div>
            ...
            <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-4">
              <h4 className="text-sm font-semibold text-white mb-3">FMLA Compliance Checklist - Garcia</h4>
              <div className="space-y-2">
                {[
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        {supportOpen && (
          <div className="absolute bottom-16 right-0 w-80 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl overflow-hidden">
            <div className="p-4 border-b border-slate-700/50">
              <h3 className="text-sm font-semibold text-white">Leave Administration Support</h3>
              <p className="text-xs text-slate-400 mt-1">GCSO Human Resources Division</p>
            </div>
            <div className="p-4 space-y-3">
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">Leave Administration</p>
                <p className="text-xs text-slate-400">C. Nguyen, HR Specialist</p>
                <p className="text-xs text-amber-400 mt-1">Ext. 4510</p>
              </div>
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">HR Director</p>
                <p className="text-xs text-slate-400">Leave policy, FMLA compliance</p>
                <p className="text-xs text-amber-400 mt-1">Ext. 4500</p>
              </div>
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">Payroll Department</p>
                <p className="text-xs text-slate-400">Leave balances, pay during leave</p>
                <p className="text-xs text-amber-400 mt-1">Ext. 4530</p>
              </div>
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">FMLA Resources</p>
                <p className="text-xs text-slate-400">DOL guidelines, WH forms</p>
              </div>
              <div className="p-3 bg-slate-800/40 rounded-lg hover:bg-slate-800/60 cursor-pointer transition-colors">
                <p className="text-sm font-medium text-white">GCSO Leave Policies</p>
                <p className="text-xs text-slate-400">Annual, sick, personal, FMLA</p>
              </div>
            </div>
          </div>
        )}

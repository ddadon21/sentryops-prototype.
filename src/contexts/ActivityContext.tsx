...
const SEED_EVENTS: ActivityEvent[] = [
  ...
  },
  {
    ...
    module: 'hr',
    title: 'New hire approved — Deputy K. Ramirez',
    message: 'Conditional offer finalized; onboarding package generated.',
    severity: 'success',
    actor: 'Patricia Henderson',
    route: '/hr/onboarding',
    read: true,
  },
  {
    ...
    module: 'hr',
    title: 'Background investigation completed — M. Rivera',
  ...
  },
  {
    ...
    module: 'hr',
    title: 'Training certification renewed — Sgt. Thompson',
    message: 'Firearms qualification renewed, valid through next annual cycle.',
    severity: 'info',
    actor: 'HR — Training & Certifications',
    route: '/hr/training',
    read: true,
  },
];
...
const SYNTHETIC_EVENTS: Omit<ActivityEvent, 'id' | 'timestamp' | 'read'>[] = [
  ...
  {
    module: 'hr',
    title: 'Employee promoted — Cpl. D. Lewis to Sergeant',
    message: 'Promotion effective next pay period; records updated.',
    severity: 'success',
    actor: 'Patricia Henderson',
    route: '/hr/records',
  },
  {
    module: 'hr',
    title: 'Performance review submitted — Deputy A. Foster',
    message: 'Annual performance review submitted by supervisor for HR sign-off.',
    severity: 'info',
    actor: 'HR — Performance Reviews',
    route: '/hr/reviews',
  },
  {
    module: 'hr',
    title: 'Internal Affairs case opened — IA-2026-031',
    message: 'New IA case opened pending preliminary review.',
    severity: 'warning',
    actor: 'Internal Affairs',
    route: '/hr/compliance',
  },
  {
    module: 'hr',
    title: 'Leave request approved — Deputy Marcus Chen',
    message: 'PTO approved for Dec 15-22; schedule updated.',
    severity: 'success',
    actor: 'Patricia Henderson',
    route: '/hr/timeoff',
  },
  {
    module: 'hr',
    title: 'Vacancy created — Patrol Deputy (District 3)',
    message: 'New vacancy opened following Cpl. Lewis promotion.',
    severity: 'info',
    actor: 'HR — Workforce Planning',
    route: '/hr/jobs',
  },
  {
    module: 'hr',
    title: 'Job posting published — Detention Officer',
    message: 'Posting live on NeoGov and agency careers page.',
    severity: 'info',
    actor: 'HR — Job Postings',
    route: '/hr/jobs',
  },
  {
    module: 'hr',
    title: 'Candidate advanced — J. Patel to Final Interview',
    message: 'Candidate cleared background stage and advanced in the pipeline.',
    severity: 'success',
    actor: 'HR — Hiring Pipeline',
    route: '/hr/pipeline',
  },
  {
    module: 'hr',
    title: 'Candidate rejected — Deputy Sheriff applicant',
  ...
  {
    module: 'hr',
    title: 'Early intervention alert generated — Deputy T. Brooks',
    message: 'Use-of-force pattern flagged by EI system for supervisor review.',
    severity: 'critical',
    actor: 'Early Intervention System',
    route: '/hr/compliance',
  },
  {
    module: 'hr',
    title: 'Employee transferred — Detective L. Ortiz to Investigations',
    message: 'Internal transfer processed; org chart and access updated.',
    severity: 'info',
    actor: 'Patricia Henderson',
    route: '/hr/records',
  },
  {
    module: 'hr',
    title: 'Shift assignment updated — A-Shift Patrol',
    message: 'Coverage adjusted to fill open vacancy on A-Shift.',
    severity: 'info',
    actor: 'HR — Workforce Planning',
    route: '/hr/timeoff',
  },
  {
    module: 'hr',
    title: 'Overtime exception approved — Deputy Chen',
    message: 'Overtime exception approved beyond standard threshold for B-Shift coverage.',
    severity: 'success',
    actor: 'Patricia Henderson',
    route: '/hr/timeoff',
  },
  {
    module: 'hr',
    title: 'Credential expired — POST Certification, Deputy Reyes',
    message: 'Certification lapsed; deputy flagged pending renewal.',
    severity: 'critical',
    actor: 'HR — Training & Certifications',
    route: '/hr/training',
  },
  {
    module: 'hr',
    title: 'Policy acknowledgment completed — Use of Force Policy v4',
    message: 'All sworn personnel have acknowledged the updated policy.',
    severity: 'success',
    actor: 'HR — Compliance',
    route: '/hr/compliance',
  },
